...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2023 at 02:12 PM
...
('manish', 1, '2023-01-28', '22:00:00', '00:00:00'),
('manish', 2, '2023-01-26', '12:45:00', '14:48:00'),
('sai', 2, '2023-01-18', '12:00:00', '14:00:00');
...
--
ALTER TABLE `event_happening`
  ADD CONSTRAINT `event_happening_ibfk_1` FOREIGN KEY (`user_name`) REFERENCES `new_regs` (`user_name`),
  ADD CONSTRAINT `event_happening_ibfk_2` FOREIGN KEY (`hid`) REFERENCES `hall_no` (`hid`);

--
-- Constraints for table `timings`
--
ALTER TABLE `timings`
  ADD CONSTRAINT `timings_ibfk_1` FOREIGN KEY (`user_name`) REFERENCES `new_regs` (`user_name`),
  ADD CONSTRAINT `timings_ibfk_2` FOREIGN KEY (`hid`) REFERENCES `hall_no` (`hid`);
COMMIT;
